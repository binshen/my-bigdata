...
//    }
    ...
    Job job = Job.getInstance(getConf(), "Parquet to text");
    job.setJarByClass(getClass());

    FileInputFormat.addInputPath(job, new Path("input/quangle.txt"));
    FileOutputFormat.setOutputPath(job, new Path("output/parquet/1"));
