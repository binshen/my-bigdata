package com.giant.hadoop.avro;// cc AvroSort A MapReduce program to sort an Avro data file
...
public class AvroSort extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    String input = "input/sample.txt";
    String output = "output/4";
    String schemaFile = "config/WeatherRecord.avsc";
